Simple example using Solr, an XML API to the Apache Lucene search engine, using 
Spring by Example's HttpClientTemplate, HttpClientOxmTemplate, and SolrOxmClient.
