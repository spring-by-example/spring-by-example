 ...
 */
public abstract class AbstractPersistenceControllerTest<R extends ResponseResult, FR extends FindResponseResult, S extends PkEntityBase> 
     ...
     * Gets result.
     */
    protected abstract S getResult(R response);

    /**
     * Gets results.
     */
    protected abstract List<S> getResults(FR response);
    ...
    public void testFindById() {
        ...
        verifyRecord(getResult(response));
    }
    ...
    public void testPaginatedFind() {
        ...
        assertNotNull("Response results is null.", getResults(response));
        verifyRecord(getResults(response).get(0));
    }
