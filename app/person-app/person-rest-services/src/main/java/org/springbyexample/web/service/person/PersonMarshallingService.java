...
public interface PersonMarshallingService extends PersistenceMarshallingService<PersonResponse, PersonFindResponse, Person> {
    ...
    public final static String FIND_PAGINATED_REQUEST = PATH_PLURAL + PAGINATED;
    public final static String FIND_REQUEST = PATH_PLURAL;
    public final static String SAVE_REQUEST = PATH;
    public final static String DELETE_REQUEST = FIND_BY_ID_REQUEST;
