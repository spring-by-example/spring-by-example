...
/**
 * <code>ValangValidator</code> custom function test.
 * 
 * @author David Winterfeldt
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration
public class ValangValidatorCustomFunctionDiscoveryTest {

	final Logger logger = LoggerFactory.getLogger(ValangValidatorCustomFunctionDiscoveryTest.class);
