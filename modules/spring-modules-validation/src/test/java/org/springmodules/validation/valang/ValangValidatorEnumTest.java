...
/**
 * <code>ValangValidator</code> enum test.
 * 
 * @author David Winterfeldt
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration
public class ValangValidatorEnumTest {

	final Logger logger = LoggerFactory.getLogger(ValangValidatorEnumTest.class);
     ...
     */
    @Test
    public void testInvalidLastNameValidation() {
        assertNotNull("Validator is null.", validator);
     ...
     */
    @Test
    public void testInvalidCreditStatusValidation() {
        assertNotNull("Validator is null.", validator);
     ...
     */
    @Test
    public void testInvalidCreditRatingValidation() {
        assertNotNull("Validator is null.", validator);
