 ...
 */
public class NotInTestPredicate extends InTestPredicate {
     ...
     */
    public NotInTestPredicate(Function leftFunction, Operator operator, Function rightFunction, int line, int column) {
