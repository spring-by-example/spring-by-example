 ...
 */
public class GreaterThanOrEqualTestPredicate extends AbstractCompareTestPredicate {
     ...
     */
    public GreaterThanOrEqualTestPredicate(Function leftFunction, Operator operator, Function rightFunction, int line, int column) {
