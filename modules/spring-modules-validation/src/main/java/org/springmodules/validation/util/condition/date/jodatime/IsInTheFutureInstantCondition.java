...
/**
 * An {@link AbstractInstantCondition} implementation that checks whether the checked instant is in the future.
 *
 * @author Uri Boness
 */
public class IsInTheFutureInstantCondition extends AbstractInstantCondition {
