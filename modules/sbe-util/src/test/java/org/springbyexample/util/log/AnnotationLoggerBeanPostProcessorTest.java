...
public class AnnotationLoggerBeanPostProcessorTest {

    final Logger logger = LoggerFactory.getLogger(AnnotationLoggerBeanPostProcessorTest.class);

    @Autowired
    protected AnnotationLoggerBean annotationLoggerBean = null;
