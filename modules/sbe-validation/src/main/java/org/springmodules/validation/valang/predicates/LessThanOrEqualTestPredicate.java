 ...
 */
public class LessThanOrEqualTestPredicate extends AbstractCompareTestPredicate {
     ...
     */
    public LessThanOrEqualTestPredicate(Function leftFunction, Operator operator, Function rightFunction, int line, int column) {
