 ...
 */
public class LessThanTestPredicate extends AbstractCompareTestPredicate {
     ...
     */
    public LessThanTestPredicate(Function leftFunction, Operator operator, Function rightFunction, int line, int column) {
