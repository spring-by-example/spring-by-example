 ...
 */
public class NotBetweenTestPredicate extends BetweenTestPredicate {
     ...
     */
    public NotBetweenTestPredicate(Function leftFunction, Operator operator, Function rightFunction, int line, int column) {
